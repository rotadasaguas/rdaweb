<div class="container">
    <div class="row" style="margin-top:35px;">
        <h2 class="center" style="font-size:24px; text-transform: uppercase;">Atualização de Dados</h2>
    </div>
    <div class="row" style="margin-top:35px;">
        <form method="post">
            <?php
                foreach($verAgencia as $l){
            ?>
            <div class="row" style="margin-top:40px;">
                ...
                <div class="input-field col s8">
                    <input placeholder="Digite os numeros para contato" value="<?php echo $l->descricao; ?>"  id="descricao" name="descricao" type="text" required>
            ...
            <div class="row" style="margin-top:40px;">
                ...
                <div class="input-field col s5">
                    <input id="bairro" name="bairro"  value="<?php echo $l->bairro; ?>" type="text" required>
            ...
            <div class="row">
                ...
                <div class="input-field col s2">
                    <input placeholder="Número" id="num_end" value="<?php echo $l->num_end; ?>" name="num_end" type="text" required>
